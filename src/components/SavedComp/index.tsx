...
export default function SavedComp({ user, song , musics,likeMusicFunc,saveMusicFunc}: { user: any, song: { isPlaying: boolean, activeSong: IActiveSong, currentIndex: number },currentUser:any ,musics:any,likeMusicFunc:any,saveMusicFunc:any}) {
  return (
